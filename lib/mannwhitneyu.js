...
// Adopted from: http://biyoenformatik.blogspot.com/2016/01/mann-whitney-u-test-wilcoxon-rank-sum.html
// converted to es6 export syntax
var rank = {
    /*
      * Standart ranking
      *
...
export function test(x, y, alt, corr) {
